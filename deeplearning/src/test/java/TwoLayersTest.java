...
//	 	
//    	JavaRDD<Tuple2<Vector,Vector>> preprocessed = layer2.preProcess(result);
...
//		Assert.assertEquals(64,imgwords.collect().get(0)._2.size());
//		JavaRDD<Tuple2<Vector,Vector>> represent = layer2.extractFeatures(result, config2, features);
//		Assert.assertEquals(50, represent.collect().size());
//		Assert.assertEquals(4, represent.collect().get(0)._2.size());
//		
//		JavaRDD<Tuple2<Vector,Vector>> pooled = layer2.pool(represent);
//		List<Tuple2<Vector,Vector>> out = pooled.collect();
...
//		JavaRDD<Tuple2<Vector,Vector>> result2 = layer2.train(result, result);
//
//		List<Tuple2<Vector,Vector>> out = result2.collect();
//		Assert.assertEquals(50, out.size());
//		Assert.assertEquals(2, out.get(0)._2.size());	
//	}
//	@Test
